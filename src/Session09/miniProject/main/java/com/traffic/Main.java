package Session09.miniProject.main.java.com.traffic;

import Session09.miniProject.main.java.com.traffic.engine.SimulationEngine;
...
public class Main {
    ...
    private static void printMenu() {
        if (isRunning) {
            System.out.println("\n=== SMART TRAFFIC SIMULATOR - ĐANG CHẠY ===");
